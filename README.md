...
- **Click any structure** (on the model or in the index) and it slides out of the brain like a Lego brick. The rest of the brain fades to a faint outline and the panel shows its anatomy, functions, clinical notes and blood supply.
